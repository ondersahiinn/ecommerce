...
const ProductItem: React.FC<ProductItemProps> = (props) => {
    const { type = "default", name, brand, id, images, disabled, discount_percentage, price, showSlider = true } = props
    const [showAddToCart, setShowAddToCart] = useState(false)
    const [activeImage, setActiveImage] = useState(0)

    const showSliderDots = showAddToCart && images.length > 1 && showSlider
    return (
